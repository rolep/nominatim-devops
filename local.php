...
@define('CONST_Website_BaseURL', getenv('NOMINATIM_WEB_BASE_URL') ? getenv('NOMINATIM_WEB_BASE_URL') : '/');
@define('CONST_Database_DSN', getenv('NOMINATIM_DB_DSN') ? getenv('NOMINATIM_DB_DSN') : 'pgsql:dbname=nominatim');
